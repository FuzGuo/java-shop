<template>
  <div style="width: 100%; height: 100vh; background-image: url('http://vikeypingne.top/wp-content/uploads/2023/12/591176a7a0556.png'); background-size: cover; background-repeat: no-repeat; background-position: center; overflow: hidden">
    <div style="width: 400px;margin:50px auto">
      ...
      <el-form-item>
        <el-button style="width: 100%; color: white; background-color: transparent; border: 1px solid white;" type="primary" @click="register">
          注册
        </el-button>
      </el-form-item>
    </div>
...
<style>
.demo-ruleForm .el-form-item label {
  color: white;
}
</style>
